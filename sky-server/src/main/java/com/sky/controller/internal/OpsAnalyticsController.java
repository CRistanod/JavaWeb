...
public class OpsAnalyticsController {
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "startTime", value = "统计开始时间，格式：yyyy-MM-dd HH:mm:ss", required = true, dataType = "string", paramType = "query", example = "2026-04-08 00:00:00"),
            @ApiImplicitParam(name = "endTime", value = "统计结束时间，格式：yyyy-MM-dd HH:mm:ss", required = true, dataType = "string", paramType = "query", example = "2026-04-08 23:59:59"),
            @ApiImplicitParam(name = "compareStartTime", value = "对比开始时间，可选；与 compareEndTime 同时传入才会返回对比指标", dataType = "string", paramType = "query", example = "2026-04-07 00:00:00"),
            @ApiImplicitParam(name = "compareEndTime", value = "对比结束时间，可选；与 compareStartTime 同时传入才会返回对比指标", dataType = "string", paramType = "query", example = "2026-04-07 23:59:59")
    })
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "startTime", value = "统计开始时间，格式：yyyy-MM-dd HH:mm:ss", required = true, dataType = "string", paramType = "query", example = "2026-04-08 00:00:00"),
            @ApiImplicitParam(name = "endTime", value = "统计结束时间，格式：yyyy-MM-dd HH:mm:ss", required = true, dataType = "string", paramType = "query", example = "2026-04-08 23:59:59"),
            @ApiImplicitParam(name = "granularity", value = "统计粒度：hour 按小时，day 按天", dataType = "string", paramType = "query", allowableValues = "hour,day", example = "hour")
    })
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "startTime", value = "统计开始时间，格式：yyyy-MM-dd HH:mm:ss", required = true, dataType = "string", paramType = "query", example = "2026-04-08 00:00:00"),
            @ApiImplicitParam(name = "endTime", value = "统计结束时间，格式：yyyy-MM-dd HH:mm:ss", required = true, dataType = "string", paramType = "query", example = "2026-04-08 23:59:59"),
            @ApiImplicitParam(name = "orderBy", value = "排序字段：revenue 按营业额，salesVolume 按销量", dataType = "string", paramType = "query", allowableValues = "revenue,salesVolume", example = "revenue"),
            @ApiImplicitParam(name = "sort", value = "排序方式：desc 降序，asc 升序", dataType = "string", paramType = "query", allowableValues = "desc,asc", example = "desc"),
            @ApiImplicitParam(name = "limit", value = "返回条数，最小 1，最大 100，默认 10", dataType = "int", paramType = "query", example = "10")
    })
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "startTime", value = "分析开始时间，格式：yyyy-MM-dd HH:mm:ss", required = true, dataType = "string", paramType = "query", example = "2026-04-08 00:00:00"),
            @ApiImplicitParam(name = "endTime", value = "分析结束时间，格式：yyyy-MM-dd HH:mm:ss", required = true, dataType = "string", paramType = "query", example = "2026-04-08 23:59:59")
    })
